        ...
        $this->refunds = new class {
            public function create($args) {
                return (object)[
                    ...
                    'amount' => 100,
                    'currency' => 'usd',
                    'toArray' => function() { return ['id'=>'re_test_123']; }
                ];
            }
        };
    }
...
// Mock Logger and EmailService if they are used
// We'll define them as classes in AperturePro\Helpers and AperturePro\Email namespaces
// But we need to define namespaces first.
